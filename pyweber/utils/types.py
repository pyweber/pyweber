...
DoubleFormnat = deprecated_alias('DoubleFormnat', DoubleFormat, alternative='DoubleFormat')
...
class ContentTypes(Enum):
    ...
    # Documentos de texto Office (abrÃ­veis como texto em alguns casos)
...
class WindowEventType(Enum):
    # Eventos de Janela e NavegaÃ§Ã£o
    ...
    # Eventos de Mensagens e ComunicaÃ§Ã£o
    MESSAGE = "onmessage"
    MESSAGE_ERROR = "onmessageerror"

    # Eventos de AnimaÃ§Ã£o e TransiÃ§Ã£o
...
class HTMLTag(Enum):
    # Tags SemÃ¢nticas e de EstruturaÃ§Ã£o
    html = "html"
    head = "head"
    body = "body"
    title = "title"
...
def __getattr__(name: str):
    if name == 'Icons':
        ...
        from pyweber.utils.icons import Icons as _Icons
        warn_deprecated(
            'pyweber.utils.types.Icons',
            alternative='pyweber.utils.icons.Icons',
            removal='2.0',
            stacklevel=2,
        )
        return _Icons
